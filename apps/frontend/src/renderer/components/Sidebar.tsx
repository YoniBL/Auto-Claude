...
export type SidebarView = 'kanban' | 'terminals' | 'roadmap' | 'context' | 'ideation' | 'github-issues' | 'gitlab-issues' | 'github-prs' | 'gitlab-merge-requests' | 'changelog' | 'insights' | 'worktrees' | 'agent-tools' | 'debug';
...
const baseNavItems: NavItem[] = [
  ...
  { id: 'debug', labelKey: 'navigation:items.debug', icon: Bug, shortcut: 'X' }
];
